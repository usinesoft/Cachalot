...
public static class ConsoleExt
{
    ...
    internal static readonly PreviousLineBuffer PreviousLineBuffer = new();

    private static readonly Dictionary<ConsoleModifiers, IConsoleAction> DefaultConsoleActions = new();
    ...
    public static LineState LineState => new(CurrentLine, Console.CursorLeft);
    ...
    public static KeyPressResult ReadKey(bool intercept)
    {
        while (true)
        {
            ...
            return new(keyInfo, lineStateBefore, LineState);
        }
    }
