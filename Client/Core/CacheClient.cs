...
//                            if (typeName == null) typeName = packedItem?.CollectionName;
...
//        }
//        //public IFeedSession BeginFeed(TypeDescriptionConfig collectionSchema, int packetSize, bool excludeFromEviction) 
//        //{
...
//            return RemoveMany(new OrQuery(typeof(TItem).FullName));
//        }
...
//        {
//            var description = RegisterTypeIfNeeded(typeof(TItemType)).AsCollectionSchema;
...
//            var request = new RegisterTypeRequest(typeDescription.AsCollectionSchema, ShardIndex, ShardsCount);
...
//        public void RegisterType(CollectionSchema collectionSchema)
//        {
//            var request = new RegisterTypeRequest(collectionSchema, ShardIndex, ShardsCount);
...
//        /// </summary>
//        /// <returns></returns>
//        public IDictionary<string, CollectionSchema> GetKnownTypes()
//        {
