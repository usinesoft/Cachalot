...
///     It has deep-equal semantics and it is used to resolve distinct clauses in queries (eliminate duplicates on a subset
///     of properties)
/// </summary>
internal sealed class Projection
{
    ...
    private List<KeyValue> Values { get; } = new();
