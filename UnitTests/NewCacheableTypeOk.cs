...
{
    [Serializable]
    public class NewCacheableTypeOk : IEquatable<NewCacheableTypeOk>
    {
        ...
        public NewCacheableTypeOk()
        {
        }

        public NewCacheableTypeOk(int primaryKey, int uniqueKey, string indexKeyFolder, DateTime indexKeyDate,
            int indexKeyValue)
        {
        ...
        public bool Equals(NewCacheableTypeOk cacheableTypeOk)
        {
