...
public class TransactionLog : IDisposable
{
    ...
    private readonly ManualResetEvent _sleepEvent = new(false);
    ...
    private readonly Queue<TransactionData> _transactionQueue = new();
    ...
    private readonly ManualResetEvent _queueNotEmpty = new(false);
